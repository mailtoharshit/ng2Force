...
$color-background-row-new: rgb(250, 255, 189)
...
$color-background-indicator-dot: rgb(159, 170, 181)
...
$color-border-brand: rgb(0, 112, 210)
...
$font-family-body: 'SalesforceSans-Regular', Arial, sans-serif
$font-family-light: 'SalesforceSans-Light', Arial, sans-serif
$font-family-strong: 'SalesforceSans-Bold', Arial, sans-serif
...
$line-height-reset: 1
$line-height-tab: 3rem
$line-height-button: 2.125rem
$line-height-button-small: 1.875rem
...
$color-text-required: rgb(212, 80, 76)
...
$shadow-overlay: 0 -2px 4px rgba(0,0,0,.07)
$shadow-drag: 0px 2px 4px 0px rgba(0,0,0,.4)
$shadow-button: 0px 1px 1px 0px rgba(0,0,0,.05)
